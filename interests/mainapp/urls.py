...
from .views import SearchResultsView,UserPostListView,PostUpdateView,PostDeleteView,PostLikeRedirect,PostLikeAPIRedirect,PostSaveRedirect,Home,PostSaveListView
...
urlpatterns = [
    ...
    path('<int:pk>/<str:slug>/comment/', views.add_comment_to_post, name='add_comment_to_post'),
